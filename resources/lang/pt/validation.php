...
return [
    ...
    */
    ...
    | utilizando a convenção "atributo.regra" para nomear as linhas. Isso nos ajuda
    | a definir uma linha de linguagem personalizada para uma determinada regra.
    |
    */
    ...
    | Isso nos ajuda a tornar nossa mensagem mais expressiva.
    |
    */
